...
{/* NOTE: Figma sidebar still shows Zoning/Setback. Replace images from staging. */}
...
<Frame caption="Selecting parcels on the map">
  <img src="/images/help/launching/site-parcel-select.png" alt="Site step showing selected parcels with parcel details in the left panel" />
</Frame>

The panel shows the address, area, and zoning code for the selected parcels. A toolbar at the top of the map provides undo, redo, and other editing tools.
...
<Frame caption="Drawing a custom site boundary">
  <img src="/images/help/launching/site-draw-boundary.png" alt="Draw Polygon mode showing instructions tooltip" />
</Frame>
...
<Frame caption="Editing an existing site boundary">
  <img src="/images/help/launching/site-edit-boundary.png" alt="Edit Polygon mode showing draggable vertex handles on the boundary" />
</Frame>
